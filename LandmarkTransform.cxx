...
vtkStandardNewMacro(LandmarkTransform);
...
//----------------------------------------------------------------------------
void LandmarkTransform::PrintSelf(ostream& os, vtkIndent indent)
{
...
void LandmarkTransform::InternalUpdate()
{
	vtkIdType i;
	int j;
...
//------------------------------------------------------------------------
unsigned long LandmarkTransform::GetMTime()
{
...
//------------------------------------------------------------------------
void LandmarkTransform::SetSourceLandmarks(vtkPoints *source)
{
...
//------------------------------------------------------------------------
void LandmarkTransform::SetTargetLandmarks(vtkPoints *target)
{
...
void LandmarkTransform::SetLandmarksWeight(vtkFloatArray *weight){
...
//----------------------------------------------------------------------------
void LandmarkTransform::Inverse()
{
...
//----------------------------------------------------------------------------
vtkAbstractTransform *LandmarkTransform::MakeTransform()
{
	return LandmarkTransform::New();
}

//----------------------------------------------------------------------------
void LandmarkTransform::InternalDeepCopy(vtkAbstractTransform *transform)
{
	LandmarkTransform *t = (LandmarkTransform *)transform;
