...
vtkActor* MeshTools::CreateGridOutline(const int type, const int plane, const int gridSize,  const double gridSpacing, const double origin[3])
{
	...
	else
	{
		...
		if (plane == 0)
		{
			...
			coord2[0] = -gridSize*gridSpacing;
			coord2[1] = 0;
			coord2[2] = 0;

			coord3[0] = -gridSize*gridSpacing;
			coord3[1] = -gridSize*gridSpacing;
			coord3[2] = 0;


			coord4[0] = 0;
			coord4[1] = gridSize*gridSpacing;
			coord4[2] = 0;
			...
			coord6[0] = 0;
			coord6[1] = -gridSize*gridSpacing;
			coord6[2] = 0;

			coord7[0] = gridSize*gridSpacing;
			coord7[1] = gridSize*gridSpacing;
			coord7[2] = 0;

			coord8[0] = gridSize*gridSpacing;
			coord8[1] = 0;
			coord8[2] = 0;

			coord9[0] = gridSize*gridSpacing;
			coord9[1] = -gridSize*gridSpacing;
			coord9[2] = 0;
		...
		else if (plane == 1)
		{
			...
			coord3[0] = -gridSize*gridSpacing;
			coord3[1] = 0;
			coord3[2] = -gridSize*gridSpacing;


			coord4[0] = 0;
			coord4[1] = 0;
			coord4[2] = gridSize*gridSpacing;
			...
			coord6[0] = 0;
			coord6[1] = 0;
			coord6[2] = -gridSize*gridSpacing;

			coord7[0] = gridSize*gridSpacing;
			coord7[1] = 0;
			coord7[2] = gridSize*gridSpacing;
		...
		vtkMath::Add(coord2, origin, coord2);
		vtkMath::Add(coord3, origin, coord3);
		vtkMath::Add(coord4, origin, coord4);
		vtkMath::Add(coord5, origin, coord5);
		vtkMath::Add(coord6, origin, coord6);
		vtkMath::Add(coord7, origin, coord7);
		vtkMath::Add(coord8, origin, coord8);
		vtkMath::Add(coord9, origin, coord9);
