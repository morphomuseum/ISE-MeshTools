...
vtkStandardNewMacro(Landmark_Transform);
...
void Landmark_Transform::InternalUpdate()
{
	vtkIdType i;
	int j;
	...
	*/
	...
	for (pt = 0; pt<N_PTS; pt++)
	{
		...
		if (pt == 1)
			cout << " pt==1   landmarksWeight:: " << (LandmarksWeight != NULL)<<"   w "<<weight << endl;
...
void Landmark_Transform::SetLandmarksWeight(vtkFloatArray *weight){
