  ...
  , Ui(new Ui::mqGridSizeDialog())
{
	...
	double GridSpacing= mqMeshToolsCore::instance()->Getmui_GridSpacing();
	...
	QString myUnit = mqMeshToolsCore::instance()->Getmui_SizeUnit();
	QString mm("mm");
	QString cm("cm");
	QString m("m");
	QString um("um");
...
void mqGridSizeDialog::editGridSize()
{
	...
	QString um("um");
	QString nm("nm");
	if (this->Ui->mm->isChecked()) { mqMeshToolsCore::instance()->Setmui_SizeUnit(mm); }
	else if (this->Ui->um->isChecked()) { mqMeshToolsCore::instance()->Setmui_SizeUnit(um); }
	else if (this->Ui->m->isChecked()) { mqMeshToolsCore::instance()->Setmui_SizeUnit(m); }
	else if (this->Ui->cm->isChecked()) { mqMeshToolsCore::instance()->Setmui_SizeUnit(cm); }
	else if (this->Ui->nm->isChecked()) { mqMeshToolsCore::instance()->Setmui_SizeUnit(nm); }
	mqMeshToolsCore::instance()->Setmui_GridSpacing(this->Ui->gridspacing->value());
